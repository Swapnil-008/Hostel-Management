...
const LaundryForm = () => {
    ...
    if (user && user.username) {
      ...
      const fetchLaundryRequests = async () => {
        try {
          ...
          const res = await axios.get(`${API_BASE_URL}/api/laundry-notifications`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // ✅ Use environment-based API URL
      await axios.post(`${API_BASE_URL}/api/laundry-notifications`, {
        student_id: user.id,
  ...
  const handleAcceptLaundryRequest = async (id) => {
    try {
      // ✅ Use environment-based API URL
      await axios.put(`${API_BASE_URL}/api/laundry-notifications/${id}/accept`);
