...
const Community = () => {
  ...
  const fetchDoctor = async () => {
    try {
      ...
      setError(null);
      // ✅ Use environment-based API URL
      const res = await axios.get(`${API_BASE_URL}/api/hostel-doctors`);
  ...
  const fetchImages = async () => {
    try {
      ...
      setError(null);
      // ✅ Use environment-based API URL
      const res = await axios.get(`${API_BASE_URL}/api/hostel-images`);
  ...
  const fetchRules = async () => {
    try {
      ...
      setError(null);
      // ✅ Use environment-based API URL
      const res = await axios.get(`${API_BASE_URL}/api/hostel-rules`);
  ...
  const handleDoctorUpdate = async (e) => {
    ...
    try {
      // ✅ Use environment-based API URL
      await axios.put(`${API_BASE_URL}/api/hostel-doctors/${doctor.id}`, doctorForm);
