    ...
    if (!user) {
      ...
      const fetchAdminProfile = async () => {
        try {
          ...
          const res = await axios.get(`${API_BASE_URL}/api/admins/${user.id}`);
          const notificationsRes = await axios.get(`${API_BASE_URL}/api/notifications?admin_id=${user.id}`);
      ...
      const fetchStudentProfile = async () => {
        try {
          // ✅ Use environment-based API URL
          const res = await axios.get(`${API_BASE_URL}/api/students/${user.id}`);
          const notificationsRes = await axios.get(`${API_BASE_URL}/api/notifications?student_id=${user.id}`);
